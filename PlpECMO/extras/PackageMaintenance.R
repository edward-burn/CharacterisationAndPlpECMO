...
OhdsiRTools::checkUsagePackage("PlpECMO")
OhdsiRTools::updateCopyrightYearFolder()

# Create manual -----------------------------------------------------------
shell("rm extras/PlpECMO.pdf")
shell("R CMD Rd2pdf ./ --output=extras/PlpECMO.pdf")
...
OhdsiRTools::insertEnvironmentSnapshotInPackage("PlpECMO")
